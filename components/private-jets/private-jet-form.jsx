  ...
  useEffect(() => {
    if (editingItem) {
      setFormData({
        ...
        category: editingItem.category || "private_jets",
        ...
        base_airport: editingItem.base_airport || "",
      ...
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto bg-gray-800 border-gray-700 text-white">
        <DialogHeader>
          <DialogTitle className="text-white flex items-center gap-2">
            ...
            {editingItem ? 'Edit' : 'Add'} Private Jet
          </DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <Tabs defaultValue="basic" className="w-full">
            <TabsList className="grid w-full grid-cols-6 bg-gray-700">
              ...
              <TabsTrigger value="jet">Jet Details</TabsTrigger>
            ...
            <TabsContent value="basic" className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-gray-700/50 border-gray-600 text-white"
                  placeholder="High-speed business jet with transcontinental range capabilities..."
                  rows={3}
                />
            ...
            <TabsContent value="jet" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleInputChange('base_airport', e.target.value)}
                    className="bg-gray-700/50 border-gray-600 text-white"
                    placeholder="Dallas Love Field"
                  />
                </div>
            ...
            <TabsContent value="technical" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="max_speed">Max Speed (knots)</Label>
                  <Input
                    id="max_speed"
                    type="number"
                    min="0"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-gray-700/50 border-gray-600 text-white"
                    placeholder="Dallas Love Field, Dallas, TX"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-gray-700/50 border-gray-600 text-white"
                    placeholder="ChIJDallasLoveField"
                  />
                </div>
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={loading} className="bg-blue-600 hover:bg-blue-700 text-white">
              {loading ? 'Saving...' : (editingItem ? 'Update Private Jet' : 'Create Private Jet')}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
